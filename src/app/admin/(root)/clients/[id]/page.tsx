            ...
            <div className="flex-1 space-y-6 sm:space-y-8 lg:space-y-10">
              <div className="flex flex-col lg:flex-row justify-between gap-4 lg:gap-5">
                ...
                <div className="flex items-center justify-between gap-2 flex-1 bg-white rounded-full py-2 px-3 sm:px-6 lg:px-8">
                  <div className="flex-1 text-center">
                    <p className="text-xs text-gray-600">{t("amountSpent")}</p>
                  ...
                  <div className="flex-1 text-center">
                    <p className="text-xs text-gray-600">{t("customerSince")}</p>
                    <p className="text-xs sm:text-sm w-full font-bold flex items-center justify-center bg-gray-200 rounded-full px-2 sm:px-3 py-1 mt-1">
              ...
              <div className="bg-white rounded-xl pb-4 shadow-sm overflow-hidden">
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="text-gray-400 uppercase bg-gray-100 rounded-xl overflow-hidden">
                        <th className={`py-3 text-center font-medium ${locale == "ar" ? "rounded-r-xl" : "rounded-l-xl"} text-xs lg:text-sm`}>
                          {t("id")}
                        </th>
                        <th className="py-3 text-center font-medium text-xs lg:text-sm">
                          {t("date")}
                        ...
                        <th className={`py-3 text-center font-medium ${locale == "en" ? "rounded-r-xl" : "rounded-l-xl"} text-xs lg:text-sm`}></th>
                      </tr>
                    </thead>
                    <tbody>
                ...
                <div className="mt-4 text-center px-4">
                  <button 
                    onClick={handleShowAllOrders} 
                    className="px-4 py-2 w-full sm:w-auto rounded-full bg-gray-100 cursor-pointer text-sm"
                  >
                    {t("seeAllOrders")}
                  </button>
                </div>
              ...
              <div className="overflow-hidden">
                <h2 className="text-xl sm:text-2xl mb-4">{t("timeLine")}</h2>
                ...
                <div className="space-y-6 sm:space-y-8 lg:space-y-10 relative">
                  <div className={`absolute -top-[15%] ${locale == "ar" ? "right-6 sm:right-9" : "left-6 sm:left-9"} z-10 w-0.5 h-[120%] bg-black`} />
            ...
            <div className="w-full xl:w-72 xl:flex-shrink-0">
              <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-medium">{t("aboutClient")}</h2>
                ...
                <div className="space-y-4">
                  <div>
                    <p className="text-sm text-gray-500 mb-1">{t("number")}</p>
                  ...
                  <div>
                    <p className="text-lg sm:text-xl mb-1">{t("clientNote")}</p>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <p className="text-xl sm:text-2xl">{t("storeCredit")}</p>
                      <button
